...
// FIX: Refactored component to use a dedicated props interface. This resolves potential type inference issues that caused the 'children' prop error, and it improves code clarity.
        ...
        <footer className="bg-gray-800/50 py-8">
            <div className="container mx-auto px-6 text-center text-gray-400">
                <div className="flex justify-center space-x-6 mb-4">
                    ...
                    <SocialIcon href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.298 1.634 4.218 3.791 4.649-.693.188-1.423.23-2.164.084.616 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.588-7.52 2.588-.49 0-.974-.028-1.455-.086 2.679 1.714 5.868 2.712 9.306 2.712 11.18 0 17.31-9.256 17.31-17.31 0-.264-.007-.528-.02-.792a12.398 12.398 0 0 0 3.05-3.166z"/></svg>
                    </SocialIcon>
                    <SocialIcon href="#">
                         <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
                    </SocialIcon>
                </div>
                <p className="text-sm">&copy; {new Date().getFullYear()} Lens Legacy. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
